...
static struct msm_gpiomux_config elite_slimbus_configs[] __initdata = {
	{
		.gpio	= ELITE_GPIO_AUD_WCD_SB_CLK,		
		.settings = {
			[GPIOMUX_SUSPENDED] = &slimbus,
		},
	},
	{
		.gpio	= ELITE_GPIO_AUD_WCD_SB_DATA,		
		.settings = {
			[GPIOMUX_SUSPENDED] = &slimbus,
		},
	},
